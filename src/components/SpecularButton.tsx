...
const SpecularButton = ({
  ...
  const propsRef = useRef<Required<Pick<SpecularButtonProps, "radius" | "lineColor" | "baseColor" | "intensity" | "shineSize" | "shineFade" | "thickness" | "speed" | "followMouse" | "proximity" | "autoAnimate">>>({
    radius,
    lineColor,
    baseColor,
    intensity,
